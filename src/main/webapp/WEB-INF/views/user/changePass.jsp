...
<%@page import="com.nhomjava.other.XCaptcha"%>
					...
					<div class="well">
						...
						<form:form action="user/change-pass/${sessionScope.user.id}.htm"
							...
							<div class="control-group">
								<label class="control-label">Mật khẩu cũ: <sup
									style="color: red">*</sup>
								</label>
								<div class="controls">
									<form:password path="password" id="password"
										placeholder="Nhập mật khẩu cũ" cssClass="form-control" />
								</div>
							</div>
							<div class="control-group">
								<label class="control-label">Mật khẩu mới: <sup
							...
							<div class="control-group">
								<label class="control-label">Nhập lại mật khẩu: <sup
									style="color: red">*</sup></label>
								<div class="controls">
