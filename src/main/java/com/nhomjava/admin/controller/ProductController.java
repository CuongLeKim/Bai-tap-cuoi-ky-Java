...
import com.nhomjava.admin.dao.ProducerDAO;
import com.nhomjava.admin.service.ProductService;
import com.nhomjava.admin.validator.ProductValidator;
import com.nhomjava.model.Product;

@Controller
@Transactional
@RequestMapping(value = "employee/product")
public class ProductController extends ShopCKCController {
